                ...
                <Card className="overflow-hidden hover:shadow-2xl transition-all duration-300 border-2 hover:border-primary/50 group">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
                    ...
                    <div className="lg:col-span-2 p-8 sm:p-10">
                      <CardHeader className="p-0 mb-6">
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            <CardTitle className="text-2xl sm:text-3xl mb-2 font-display group-hover:-translate-y-1 transition-transform duration-300">{caseStudy.business}</CardTitle>
                    ...
                    <div className="bg-gradient-to-br from-primary/5 to-secondary/5 p-8 sm:p-10 flex flex-col justify-center">
                      <h4 className="font-display font-bold text-foreground mb-6 text-xl">Results</h4>
